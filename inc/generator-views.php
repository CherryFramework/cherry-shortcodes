...
class Cherry_Shortcodes_Generator_Views {
	...
	public static function color( $id, $field ) {
		$return = '<span class="cherry-generator-select-color"><span class="cherry-generator-select-color-wheel"></span><input type="text" name="' . $id . '" value="' . $field['default'] . '" id="cherry-generator-attr-' . $id . '" class="cherry-generator-attr cherry-generator-select-color-value" /></span>';
		return $return;
	}
	...
	public static function border( $id, $field ) {
		...
		$return = '<div class="cherry-generator-border-picker"><span class="cherry-generator-border-picker-field"><input type="number" min="-1000" max="1000" step="1" value="' . $defaults[0] . '" class="cherry-generator-bp-width" /><small>' . __( 'Border width', 'cherry-shortcodes' ) . ' (px)</small></span><span class="cherry-generator-border-picker-field">' . $borders . '<small>' . __( 'Border style', 'cherry-shortcodes' ) . '</small></span><span class="cherry-generator-border-picker-field cherry-generator-border-picker-color"><span class="cherry-generator-border-picker-color-wheel"></span><input type="text" value="' . $defaults[2] . '" class="cherry-generator-border-picker-color-value" /><small>' . __( 'Border color', 'cherry-shortcodes' ) . '</small></span><input type="hidden" name="' . $id . '" value="' . esc_attr( $field['default'] ) . '" id="cherry-generator-attr-' . $id . '" class="cherry-generator-attr" /></div>';
		return $return;
	}
